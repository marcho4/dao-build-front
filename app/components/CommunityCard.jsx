...
export const CommunityCard = ({ imageSrc, title, description, onClick }) => {
    return (
        <div onClick={onClick} className="min-h-40 min-w-52 bg-[#deeaff] transition-all duration-300 ease-in-out hover:shadow-2xl hover:scale-105 hover:border-gray-300
         max-w-64 rounded-3xl flex flex-col p-4 cursor-pointer">
            ...
            <div className="max-w-fit mt-auto font-bold text-left py-1.5 px-3 hover:text-white cursor-pointer rounded-xl bg-[#252AD0] text-white">
                See more
            </div>
        </div>
    );
